...
#     pub_to_check = create_pub_dict_for_saving_PubMed(pub_no_PMCID)
...
#     pub_to_check = create_pub_dict_for_saving_PubMed(pub_with_PMCID, True)
...
def test_modify_pub_dict_for_saving_with_PMCID(modified_PubMed_XML):
    ...
    pub_to_check = create_pub_dict_for_saving_PubMed(modified_PubMed_XML, True)
